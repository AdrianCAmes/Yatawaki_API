...
import static com.orchestrator.orchestrator.model.dto.EqualsTester.newInstance;
...
public abstract class DtoTest<T> {
    ...
    static {
        ...
        mapperBuilder.put(LocalDate.class, () -> LocalDate.of(2020, Month.APRIL, 8));
    ...
    public void testEqualsAndHashCode() {
        EqualsTester<T> equalsTester = newInstance( getInstance() );
        equalsTester.assertEqual( getInstance(), getInstance() );
        equalsTester.assertNotEqual( getInstance(), new Object() );
    }
